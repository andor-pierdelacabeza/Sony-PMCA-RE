...
def main():
    ...
    install = subparsers.add_parser(
        "install",
        description="Installs an apk file on the camera connected via USB. The connection can be tested without specifying a file.",
    )
